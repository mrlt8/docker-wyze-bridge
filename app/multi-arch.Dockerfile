...
RUN pip3 install --no-warn-script-location --prefix=/build https://github.com/mrlt8/wyzecam/archive/refs/heads/main.zip supervisor requests
...
ADD https://github.com/aler9/rtsp-simple-server/releases/download/v0.17.2/rtsp-simple-server_v0.17.2_linux_${RTSP_ARCH:-amd64}.tar.gz /tmp/rtsp.tar.gz
RUN mkdir -p /app &&\
